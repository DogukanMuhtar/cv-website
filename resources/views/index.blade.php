...
<head>
    ...
    <title>Doğukan Muhtar - CV</title>

    <meta name="description" content="Doğukan Muhtar - Computer Engineering Student & Developer Resume">
...
<body>
                    ...
                    <div class="o-section__content  t-section__content  ">
                        ...
                        <div class="o-content">
                            <div class="c-intro">
                                <div class="o-content__body">
                                    <p>
                                        Hello! I am Doğukan Muhtar, a computer engineering student passionate about
                                        software development, system architecture, and modern web technologies. I enjoy
                                        turning complex problems into clean, efficient, and scalable digital solutions.
                                    </p>
                                    <p>
                                        Throughout my academic and independent journey, I have explored various domains
                                        ranging from hardware-software integration and circuit analysis to full-stack
                                        web platforms and multi-vendor price comparison engines like Fiyat Radar. I am
                                        constantly eager to learn, build, and push the boundaries of technology.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="o-grid">
                            ...
                            <div class="o-grid__col-sm-6">
                                <div class="o-media  o-media--block  o-content">
                                    ...
                                    <div class="o-media__body  o-content__body">
                                        ...
                                        <p>
                                            Building dynamic web applications and scalable platforms, such as
                                            multi-vendor price comparison systems, focusing on clean architecture and
                                            user experience.
                                        </p>
                                    </div>
                            ...
                            <div class="o-grid__col-sm-6">
                                <div class="o-media  o-media--block  o-content">
                                    ...
                                    <div class="o-media__body  o-content__body">
                                        <h3>Backend Development &amp; Hardware</h3>
                                        <p>
                                            Experienced in designing and building scalable backend architectures and web
                                            applications, with a strong focus on clean code, database management, and
                                            efficient multi-vendor data processing.
                                        </p>
                                    </div>
                                </div><!-- /o-media o-content -->
                            </div><!-- /o-grid__col -->
                            ...
                            <div class="o-grid__col-sm-6">
                                <div class="o-media  o-media--block  o-content">
                                    ...
                                    <div class="o-media__body  o-content__body">
                                        ...
                                        <p>
                                            Applying mathematical modeling, linear programming, and optimization
                                            algorithms to solve complex logistical and industrial problems.
                                        </p>
                                    </div>
                                </div><!-- /o-media o-content -->
                            </div><!-- /o-grid__col -->
                            ...
                            <div class="o-grid__col-sm-6">
                                <div class="o-media  o-media--block  o-content">
                                    ...
                                    <div class="o-media__body  o-content__body">
                                        ...
                                        <p>
                                            Analyzing continuous and discrete-time signals using Laplace transforms,
                                            Z-transforms, and region of convergence (ROC) visualizations.
                                        </p>
                                    </div>
                                </div><!-- /o-media o-content -->
                            </div><!-- /o-grid__col -->
                            ...
                            <div class="o-grid__col-sm-6">
                                <div class="o-media  o-media--block  o-content">
                                    ...
                                    <div class="o-media__body  o-content__body">
                                        ...
                                        <p>
                                            Researching and implementing computer network security monitoring systems
                                            and cloud computing storage security applications.
                                        </p>
                                    </div>
                                </div><!-- /o-media o-content -->
                            </div><!-- /o-grid__col -->
                            ...
                            <div class="o-grid__col-sm-6">
                                <div class="o-media  o-media--block  o-content">
                                    ...
                                    <div class="o-media__body  o-content__body">
                                        ...
                                        <p>
                                            Writing efficient code, developing software logic, and leveraging modern
                                            programming tools to tackle computer engineering challenges.
                                        </p>
                                    </div>
                                </div><!-- /o-media o-content -->
                            </div><!-- /o-grid__col -->
                            ...
                            <div class="o-grid__col-sm-6">
                                <div class="o-content">
                                    <div class="o-media  o-media--block">
                                        ...
                                        <div class="o-media__body">
                                            <h3>Hardware Simulation (Tinkercad)</h3>
                                        </div>
                                    </div>
                                    <div class="c-progress-bar  o-content__body  t-border-color-bg  u-mt-text">
                                        <div class="a-progress-bar  c-progress-bar__filler  t-primary-bg"
                ...
                <div class="o-section__container">
                    ...
                    <header class="o-section__header  t-section__header">
                        <div class="o-content">
                            ...
                            <div class="o-content__body  o-section__description">
                                My academic and development milestones.
                            </div>
                        </div>
                    </header><!-- /o-section__header -->
                                ...
                                <div class="o-content">
                                    <div class="o-grid">
                                        ...
                                        <div class="o-grid__col-md-7">
                                            <p>
                                                Building and designing a digital price comparison platform to list and
                                                aggregate products efficiently from multiple vendors, featuring custom
                                                branding and modern web interfaces.
                                            </p>
                                        </div>
                                    </div><!-- /o-grid -->
                                </div><!-- /o-content -->
                                ...
                                <div class="o-content">
                                    <div class="o-grid">
                                        <div class="o-grid__col-md-5">
                                            ...
                                            <h3 class="c-work__heading">
                                                Human Resource CV System
                                            </h3>
                                            <h4 class="c-work__title">
                                                Tinkercad System Developer
                                            </h4>
                                            <div class="c-work__location">
                                                University Project
                                            </div>
                                        ...
                                        <div class="o-grid__col-md-7">
                                            <p>
                                                Built a full-featured HR management and CV tracking web application
                                                using Laravel to automate recruitment pipelines and simplify candidate
                                                evaluation.
                                            </p>
                                        </div>
                                    </div><!-- /o-grid -->
                                ...
                                <div class="o-content">
                                    <div class="o-grid">
                                        <div class="o-grid__col-md-5">
                                            ...
                                            <h3 class="c-work__heading">
                                                DOGU COACHING - ONLINE FITNESS COACHING
                                            </h3>
                                            <h4 class="c-work__title">
                                                Academic Researcher
                                            </h4>
                                        ...
                                        <div class="o-grid__col-md-7">
                                            <p>
                                                Built DOGU COACHING, a feature-rich digital platform dedicated to
                                                delivering personalized online fitness coaching, nutrition guidance, and
                                ...
                                <div class="c-timeline__item">
                                    ...
                                    <div class="o-content">
                                        <div class="o-grid">
                                            ...
                                            <div class="o-grid__col-md-7">
                                                <p>
                                                    Pursuing a comprehensive curriculum covering advanced software
                                                    engineering, circuit analysis, signals and systems, operations
                                                    research, and core computing foundations.
                                                </p>
                                            </div>
                                        </div><!-- /o-grid -->
                                    </div><!-- /o-content -->
                                    ...
                                    <div class="o-content">
                                        <div class="o-grid">
                                            <div class="o-grid__col-md-5">
                                                ...
                                                <h3 class="c-work__heading">
                                                    Kaplan International English School - Dublin
                                                </h3>
                                                <h4 class="c-work__title">
                                            ...
                                            <div class="o-grid__col-md-7">
                                                <p>
                                                    Completed intensive international language training to enhance
                                                    professional communication and technical proficiency, achieving an
                                                    advanced B2 level in English.
                                                </p>
                                            </div>
                                        </div><!-- /o-grid -->
                                    </div><!-- /o-content -->
                ...
                <div class="o-section__container">
                    ...
                    <div class="o-section__content  t-section__content  ">
                        ...
                        <div class="o-grid">
                                    ...
                                    <a href="https://github.com/hatra-e/" target="_blank" class="t-link-container">
                                        <div class="o-media  o-media--block">
                                            ...
                                            <div class="o-media__body  o-content__body">
                                                ...
                                                <p>
                                                    Check out my repositories, code snippets, and open source projects.
                                                </p>
                                            </div>
                                        </div><!-- /o-media -->
                                    </a><!-- /t-link-container -->
                                    ...
                                    <a href="https://linkedin.com" target="_blank" class="t-link-container">
                                        <div class="o-media  o-media--block">
                                            ...
                                            <div class="o-media__body  o-content__body">
                                                ...
                                                <p>
                                                    Connect with me professionally and follow my career updates.
                                                </p>
                                            </div>
                                        </div><!-- /o-media -->
                                    </a><!-- /t-link-container -->
                            ...
                            <div class="o-grid__col-xl-4  o-grid__col-sm-6">
                                <div class="o-content">
                                    <a href="https://twitter.com" target="_blank" class="t-link-container">
                                        <div class="o-media  o-media--block">
                                            <div class="o-media__figure">
    ...
    <script src="{{ asset('assets/js/dense.js') }}"></script>
